...
//2.Returns a state based on a state ID
...
//4.Returns a district based on a district ID
...
//6.Updates the details of a player in the team(database) based on the player ID
...
//7.Returns a object containing the state name of a district based on the district id
